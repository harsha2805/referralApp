...
$(function () {
    var dtUserList = $('#tblUserList').DataTable({
        ...
        columns: [
            ...
            {data: 'referral_key', name: 'referral_key'},
            {data: 'current_position', name: 'current_position', orderable: false, searchable: false,  className: 'dt-center'},
            {data: 'referrers', name: 'referrers', orderable: false, searchable: false,  className: 'dt-center'},
