    ...
    <div id="success-section" class="success">
        ...
        <div class="share-button">
            <p>
                ...
                <button class="button" data-sharer="twitter" data-title="{{__('messages.share_msg')}}" data-hashtags="{{__('messages.share_msg')}}" data-url="referral_url_placeholder">Share on Twitter</button>
            </p>
        </div>
    </div>
